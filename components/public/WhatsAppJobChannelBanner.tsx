...
export default function WhatsAppJobChannelBanner() {
  return (
    <aside
      aria-label="Saluran WhatsApp Info Job PMS Pusat"
        ...
        <div className="anim-fade-up flex flex-col lg:flex-row lg:items-center justify-between gap-8 p-6 sm:p-8 rounded-2xl border border-white/10 bg-white/[0.03]">
          ...
          <div className="flex flex-col sm:flex-row lg:flex-col gap-3 shrink-0">
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 px-6 py-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs sm:text-sm shadow-sm transition-all hover:-translate-y-0.5"
            >
              <MessageCircle className="w-5 h-5 fill-white" />
              <span>Gabung Channel Info Job PMS</span>
              <ArrowUpRight className="w-4 h-4" />
            </a>
            <div className="text-[11px] text-slate-500 text-center lg:text-right font-mono">
