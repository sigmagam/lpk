  ...
  return (
    <aside aria-label="Narahubung Cepat WhatsApp & Saluran Info Job">
      ...
      <button
        ...
        className="anim-wa-bounce fixed bottom-6 right-4 sm:right-6 z-40 flex items-center gap-2 px-4 py-3 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-xl transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 cursor-pointer focus:outline-none focus:ring-4 focus:ring-emerald-300"
      >
