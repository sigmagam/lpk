...
import { ShieldCheck, Menu, X, ArrowUpRight, LayoutDashboard, MessageCircle } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Notification Bar - Institutional Credibility */}
      <div className="bg-navy-950 text-slate-300 text-xs py-2 border-b border-navy-800/80 hidden md:block">
        <div className="mx-auto max-w-site px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <LayoutDashboard className="w-3.5 h-3.5 text-primary-400 group-hover:text-primary-300" />
        ...
        <div className="mx-auto max-w-site px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="font-heading font-extrabold text-navy-900 text-sm sm:text-base leading-tight tracking-tight uppercase group-hover:text-primary-700 transition-colors">
          ...
          <div className="flex items-center gap-2 xl:hidden">
            ...
            <button
              ...
              className="p-2.5 rounded-lg text-slate-700 hover:text-navy-900 hover:bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-navy-800"
          ...
          <div className="fixed inset-y-0 right-0 w-full max-w-sm bg-white shadow-2xl flex flex-col z-50 animate-fade-up">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-1.5">
              ...
              <div className="pt-4 mt-4 border-t border-slate-200">
                ...
                >
                  <LayoutDashboard className="w-4 h-4 text-primary-700" />
                  <span>Dashboard Admin & Pengelolaan</span>
                </Link>
              </div>
            </div>
