  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-site px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-navy-900 border border-navy-700 text-xs font-bold text-emerald-300 uppercase tracking-wider mb-6">
        ...
        <p className="text-slate-100 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-10 font-normal">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            href="/program"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-navy-900 hover:bg-navy-800 text-white font-bold text-sm border border-navy-700 transition-all hover:border-slate-400"
          >
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-xs text-slate-300 font-semibold">
