    ...
    <div className="space-y-6 animate-fade-up">
      <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary-50 text-primary-700 text-xs font-bold border border-primary-100 mb-2">
          ...
          <Link
            href="/program"
            target="_blank"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold self-start sm:self-auto"
          >
        ...
        {programs.map((prog, idx) => (
          ...
          >
            ...
            <div className="pt-5 mt-5 border-t border-slate-100 flex items-center justify-between">
              ...
              <Link
                href={prog.href}
                className="inline-flex items-center gap-1 text-xs font-bold text-navy-950 hover:text-primary-700 transition-colors"
              >
                <span>Detail</span>
