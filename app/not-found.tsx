...
export const metadata: Metadata = {
  title: "Halaman Tidak Ditemukan | LPK Panca Multiguna Sukses Karawang",
};
  ...
  return (
    <div className="bg-slate-50 flex min-h-[70vh] flex-col items-center justify-center py-20 px-4">
      <div className="text-center max-w-md flex flex-col items-center">
        <Image src="/images/logo.png" alt="Logo LPK Panca Multiguna Sukses Karawang" width={64} height={64} className="mb-6 opacity-80" />
