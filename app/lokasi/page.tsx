            ...
            <div className="p-8 sm:p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="flex-1 inline-flex h-14 items-center justify-center rounded-xl bg-brand-600 px-6 text-base font-semibold text-white transition-all hover:bg-brand-700 hover:shadow-md"
                >
