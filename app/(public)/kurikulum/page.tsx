              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 pb-6 border-b border-slate-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="text-xs font-bold uppercase text-primary-700 tracking-wider block">
                        {item.phase}
                      </span>
                  ...
                  <span className="px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-bold self-start md:self-auto">
                    Tahap 0{idx + 1}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {item.details.map((detail, dIdx) => (
                      <div
                        key={dIdx}
                        className="flex items-center gap-3 p-4 rounded-2xl bg-slate-50 border border-slate-100 text-xs sm:text-sm text-navy-950 font-semibold"
                      >
