            ...
            {keunggulan.map((item, idx) => (
              <div
                ...
                className={`card-3d-interactive bg-white rounded-3xl p-8 sm:p-10 border border-slate-200 shadow-sm flex flex-col justify-between ${
                  idx === 0 ? "md:border-primary-300 bg-gradient-to-br from-white to-primary-50/30" : ""
                }`}
              >
                <div>
                ...
                <div className="mt-8 pt-6 border-t border-slate-200 flex items-center justify-between text-xs font-bold text-slate-700">
