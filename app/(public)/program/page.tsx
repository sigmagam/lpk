              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-4 space-y-3">
                    ...
                    <div className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-800 bg-slate-100 px-3 py-1.5 rounded-full border border-slate-300">
                  ...
                  {/* Right: Actions */}
                  <div className="lg:col-span-3 flex flex-col sm:flex-row lg:flex-col gap-3 lg:items-end justify-between h-full pt-4 lg:pt-0 border-t lg:border-t-0 border-slate-200">
                    <Link
                      href={program.href}
                      className="w-full sm:w-auto lg:w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-navy-950 hover:bg-navy-900 text-white text-xs font-bold transition-colors text-center shadow-sm"
                    >
                    ...
                    <a
                      ...
                      className="w-full sm:w-auto lg:w-full inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-900 text-xs font-bold transition-colors text-center border border-slate-300"
                    >
