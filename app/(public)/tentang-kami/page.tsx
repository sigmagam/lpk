        ...
        <div className="mx-auto max-w-site px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="card-3d-interactive w-full max-w-md p-8 sm:p-10 rounded-3xl bg-slate-50 border border-slate-200 text-center shadow-subtle-3d">
                ...
                <h3 className="font-heading font-extrabold text-navy-950 text-base sm:text-lg uppercase">
                ...
                <div className="mt-6 pt-6 border-t border-slate-200 text-left space-y-2 text-xs text-slate-600">
            ...
            <div className="lg:col-span-7 space-y-6 text-slate-700 text-base leading-relaxed">
              ...
              <p className="font-medium text-navy-950 text-lg">
              ...
              <div className="pt-4 flex flex-wrap items-center gap-4">
                <Link
                  href="/program"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-navy-900 hover:bg-navy-800 text-white font-bold text-xs transition-colors"
                >
                ...
                <Link
                  href="/legalitas"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-navy-950 font-bold text-xs transition-colors"
                >
